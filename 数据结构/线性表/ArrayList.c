...
void Free(List *l) { free(l); }

int Size(List *l) { return l->last + 1; }

int Empty(List *l) { return 0 == Size(l); }

//数组空间满。
int Full(List *l) { return MAXN == Size(l); }
...
int CmpElem(const void *a, const void *b) { return *(int *)a - *(int *)b; }

void Sort(List *l) { qsort(l->data, Size(l), sizeof(int), CmpElem); }
