...
bool cmpByPos(Ball &a, Ball &b) { return a.pos < b.pos; }
bool cmpById(Ball &a, Ball &b) { return a.id < b.id; }
    ...
    for (int i = 0; i < N; ++i) {
      ...
      */
      ...
      if (i == 0 && b.pos == 1 && b.dir == DirL) {
        ...
        next[i].pos = L;
        next[i].dir = DirL;
      } else if (i > 0 && b.dir == DirL && bs[i - 1].dir == DirR &&
                 b.pos - bs[i - 1].pos == 2) {
        // 和左边的球碰撞。
        next[i].pos = b.pos - 1;
        next[i].dir = DirR;
      } else if (i < N - 1 && b.dir == DirR && bs[i + 1].dir == DirL &&
                 bs[i + 1].pos - b.pos == 2) {
        // 和右边的球碰撞。
        next[i].pos = b.pos + 1;
        next[i].dir = DirL;
